...
def test_event_pages_exist():
    ...
    for filename in expected_files:
        assert os.path.exists(os.path.join("view", filename)), f"Expected event page {filename} not found in view/"
...
def test_event_page_titles():
    ...
    with open("view/2025-02-16-evenement-2.html", "r", encoding="utf-8") as f:
        content = f.read()
...
def test_common_layout_elements_in_event_page():
    with open("view/2025-03-23-evenement-3.html", "r", encoding="utf-8") as f:
        content = f.read()
